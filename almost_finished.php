<?php
  $page_title = 'Low Stock Products (Less than 5)';
  ...
  // Get all low-stock products for the current page
  $products = join_product_table_low_stock($offset, $limit);

  // Get the total number of low-stock products
  $total_products = count_low_stock_products();
            ...
            <ul class="pagination">
              <?php for($i = 1; $i <= $total_pages; $i++): ?>
                <li class="<?php echo ($i == $page) ? 'active' : ''; ?>">
                  <a href="low_stock_products.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
              <?php endfor; ?>
            </ul>
          <?php endif; ?>
