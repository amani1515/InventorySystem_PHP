...
<div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3><img src="img/logo.png" class="img-fluid"/><span>ወረታ </span></h3>
            </div>
            <ul class="list-unstyled components">
			<li  class="active">
                    <a href="admin.php" class="dashboard"><i class="material-icons">dashboard</i>
...
logout</span>Logout</a>
		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title"><a href="../admin.php">Dashboard</a></h4>  
                  <ol class="breadcrumb">
